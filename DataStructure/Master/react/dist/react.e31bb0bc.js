...
// 来源(good)：https://github.com/hujiulong/blog/issues/4
...
var ReactDOM = {
  render: function render(vnode, container) {
    container.innerHTML = ''; //下面是实现加子children功能，必须清理一波
...
function tick() {
  // const  element1 = <h1>Hello mochixuan!</h1>;
  var element1 = React.createElement("div", null, React.createElement("h1", null, "Hello MoChiXuan!"), React.createElement("h2", null, "It is ", new Date().toLocaleTimeString()));
